...
# (locality, lat, lng, price_per_sqft_base, tier)
# tier roughly captures how premium/central a locality is; used to vary
# price-per-sqft and nearby-amenity distances realistically.
LOCALITIES = [
